...
1. Heart disease example shows that variables, while on it own being significant, in the presence of many correlated variables, could be no longer significant and can even get negative sign. Interpretation of coefficients in logistic regression is every unit of input increases accounts for an increase of exp(coef)*100\% in the response.
